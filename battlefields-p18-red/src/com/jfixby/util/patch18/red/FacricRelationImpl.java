...
class FacricRelationImpl implements FabricsRelation {
	...
	public int hashCode () {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((lowerFabric == null) ? 0 : lowerFabric.hashCode());
		result = prime * result + ((upperFabric == null) ? 0 : upperFabric.hashCode());
		return result;
	}
	...
	public boolean equals (Object obj) {
		...
		if (lowerFabric == null) {
			if (other.lowerFabric != null) return false;
		} else if (!lowerFabric.equals(other.lowerFabric)) return false;
		if (upperFabric == null) {
			if (other.upperFabric != null) return false;
		} else if (!upperFabric.equals(other.upperFabric)) return false;
		return true;
	}
	...
	public String getIDString () {
		return upperFabric.getName().toLowerCase() + "-on-" + lowerFabric.getName().toLowerCase();
	}
