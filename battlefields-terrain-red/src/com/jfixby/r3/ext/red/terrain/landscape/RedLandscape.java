...
public class RedLandscape<T> implements Landscape<T> {
	...
	private final RedLandscapeOperationResult<T> result = new RedLandscapeOperationResult<>(this);
...
// }
	...
	public LandscapeOperationResult<T> newBlock (final T keypoint, final TerrainType terrain_type) {
		...
		final TerrainBlock<T> added = new RedTerrain<>(keypoint, terrain_type);
