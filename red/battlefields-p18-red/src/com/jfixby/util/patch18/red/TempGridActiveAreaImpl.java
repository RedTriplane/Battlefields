...
public class TempGridActiveAreaImpl implements GridActiveArea {
	...
	public boolean isInside (long cell_x, long cell_y) {
		int points = FloatMath.INDEX(this.isDotInside(cell_x, cell_y)) + FloatMath.INDEX(this.isDotInside(cell_x + 1, cell_y))
			+ FloatMath.INDEX(this.isDotInside(cell_x, cell_y + 1)) + FloatMath.INDEX(this.isDotInside(cell_x + 1, cell_y + 1));
