...
public class CellMark implements Cell {
	...
	public boolean equals (Object obj) {
		...
		if (cell_xy == null) {
			if (other.cell_xy != null) return false;
		} else if (!cell_xy.equals(other.cell_xy)) return false;
		return true;
	}
	...
	public Fabric getUpperFabric () {
		return composed.getValue(cell_xy.getX(), cell_xy.getY()).getUpperFabric();
	}

	@Override
	public Fabric getLowerFabric () {
		return composed.getValue(cell_xy.getX(), cell_xy.getY()).getLowerFabric();
	}
