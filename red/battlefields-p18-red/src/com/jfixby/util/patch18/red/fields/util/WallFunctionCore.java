...
public class WallFunctionCore {
	...
	public static WallFunction process (final BoolFunction bool_field) {
		...
		WallsFieldSchematic field_properties = FieldsFactory.newWallsFieldProperties();
	...
	private static Patch18 boolToAPatch (BoolFunction bool_field, long grid_cell_x, long grid_cell_y) {
